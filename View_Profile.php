...
<?php
include 'dbcon.php';
	$email = $_SESSION['fetchemail'];
	
	$updatequery = "select * from signup where email = '$email'";
...
<body>
	...
	<div class="w3-sidebar w3-bar-block w3-collapse w3-theme w3-animate-left" style="z-index:3; width:250px" id="mySidebar">
		<div class="w3-bar w3-large">
			...
			<a class="w3-bar-item w3-button w3-green w3-hover-green" href="View_Profile.php"><i class="fa fa-user-circle fa-fw"></i> View Profile</a>
