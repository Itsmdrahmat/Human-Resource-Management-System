...
<body>
	...
	<a href="Upcoming_training.php" id="filter" class="w3-green w3-button w3-hover-green">Upcoming</a>
	...
	<?php
		include 'dbcon.php';
		$selectquery = "SELECT *from training where status ='Upcoming' ORDER BY training_id DESC";
		$query = mysqli_query($con,$selectquery);
