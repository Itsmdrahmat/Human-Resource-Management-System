...
<body>
	...
	<a href="Running_training.php" id="filter" class="w3-green w3-button w3-hover-green">Running</a>
	...
	<?php
		include 'dbcon.php';
		$selectquery = "SELECT *from training where status = 'Running' ORDER BY training_id DESC";
		$query = mysqli_query($con,$selectquery);
