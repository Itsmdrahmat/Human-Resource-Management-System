...
if(isset($_POST['submit']))
{
	...
	if(($fromdate >= $creating_date) && ($todate >= $fromdate))
	{
...
<body>
	...
	<div align="center">
	<b>Filter :</b>&nbsp;&nbsp;&nbsp;	
	<a href="Manage_Training.php" id="filter" class="w3-green w3-button w3-hover-green">Show All</a>
	...
	<a href="Completed_training.php" id="filter" class="w3-theme w3-button w3-hover-green">Completed</a>
	</div>
	...
	<?php
		include 'dbcon.php';
		$selectquery = "select *from training ORDER BY training_id DESC";
		$query = mysqli_query($con,$selectquery);
