...
include 'dbcon.php';
	...
	$updatequery = "select * from notice where notice_id = '$notice_id'";
...
<body>
	...
	<div class="w3-main w3-container" style="margin-left:250px;margin-top:60px;">
		<p><a href="Manage_Notice.php">Manage Notice</a> &#8680; <a href="view_notice.php">View Notice</a></p>
	<div class="w3-container w3-light-gray">
	<h2 align="center" class="w3-text-indigo"><i class="fa fa-comment"></i> Notice View</h2><br>
	...
	<tr>
		<td>Notice ID</td>
		<td><?php echo $arrdata['notice_id']; ?></td>
	</tr>
	<tr>
		<td>Name</td>
	...
	<tr>
		<td>Subject</td>
		<td><?php echo $arrdata['subject']; ?></td>
	</tr>
	<tr>
		<td>Created Date</td>
	...
	<tr>
		<td>Description</td>
		<td><?php echo $arrdata['description']; ?></td>
	</tr>
