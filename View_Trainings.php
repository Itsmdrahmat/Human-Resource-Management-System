...
<body>
	...
	<div class="w3-sidebar w3-bar-block w3-collapse w3-theme w3-animate-left" style="z-index:3; width:250px" id="mySidebar">
		<div class="w3-bar w3-large">
			...
			<a class="w3-bar-item w3-button w3-green w3-hover-green" href="View_Trainings.php"><i class="fa fa-address-book fa-fw"></i> View Trainings</a>
	...
	<h2 align="center" class="w3-text-indigo"><i class="fa fa-address-book"></i> Trainings Details</h2><br>
	...
	<?php
		...
		$selectarray = "SELECT * from training";
