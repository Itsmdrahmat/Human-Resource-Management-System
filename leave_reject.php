...
<body>
	...
	<a href="leave_approve.php" id="filter" class="w3-theme w3-button w3-hover-green">Approved</a>
	<a href="leave_reject.php" id="filter" class="w3-green w3-button w3-hover-green">Rejected</a>
	</div><br>
	...
	<?php
		include 'dbcon.php';
		$selectquery = "select *from leaves where status = 'Rejected' ORDER BY leave_id DESC";
