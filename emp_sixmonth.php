...
<body>
	...
	<a href="emp_oldest.php" id="filter" class="w3-theme w3-button w3-hover-green">Oldest First</a>
	<a href="emp_sixmonth.php" id="filter" class="w3-green w3-button w3-hover-green">Last 6 Months</a>
	...
	<?php
		...
		$selectquery = "SELECT *from employee where emp_doj > '$lastsix' ORDER BY emp_id DESC";
