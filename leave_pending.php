...
<body>
	...
	<a href="leave_pending.php" id="filter" class="w3-green w3-button w3-hover-green">Pending</a>
	...
	<?php
		include 'dbcon.php';
		$selectquery = "select *from leaves where status = 'Pending' ORDER BY leave_id DESC";
